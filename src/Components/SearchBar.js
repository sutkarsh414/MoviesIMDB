...
//             method: 'GET',
//             headers: {
//                 'X-RapidAPI-Key': 'df7e345e41mshe1f9b48d12cac66p1b090bjsnc7bc3719b888',
//                 'X-RapidAPI-Host': 'online-movie-database.p.rapidapi.com'
//             }
//         };
        
//         fetch('https://online-movie-database.p.rapidapi.com/auto-complete?q=' + IMDBctx.searchValue, options)
//             .then(response => response.json())
//             .then(response => {
//                 debugger
//                 IMDBctx.serMoviesData(response.d)
//             })
...
//   },[IMDBctx.searchValue,IMDBctx])
  ...
  return (
    <>
      <div className="h-64 bg-white rounded-2xl flex justify-between text-lg relative">
        <input
          className="relative rounded-2xl left-4 focus:outline-0 text-black text-center"
          placeholder="Movie Name"
          value={IMDBctx.searchValue}
          onChange={(e)=>{IMDBctx.setSearchValue(e.target.value)}}
        ></input>
      </div>
    </>
  );
